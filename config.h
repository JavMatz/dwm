...
static char emoji_font[]      = "NotoColorEmoji:pixelsize=11:antialias=true:autohint=true";
static char dmenufont[]       = "monospace:size=10";
static const char *fonts[]          = { font, emoji_font };
...
static const Rule rules[] = {
	...
	/* Tag 5 */
	{ "Steam",   "Steam",       "Lista de amigos",       1 << 4,       0,           -1 },
	{ "Steam",   "Steam",       "Steam",       1 << 4,       0,           -1 },
	/* Tag 2 */
...
static const char *dmenucmd[] = { "dmenu_drun", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, NULL };
...
static Key keys[] = {
	...
	/* Keepmenu */
	{ MODKEY,        	  XK_w,                      spawn,          SHCMD("keepmenu") },
	/* Clipmenu */
